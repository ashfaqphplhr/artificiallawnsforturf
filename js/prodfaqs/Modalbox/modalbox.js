...
Modalbox.Methods = {
	...
	options: {
		...
		height: 800, // Default height in px
	...
	hide: function(options) { // External hide method to use from external HTML and JS
		if(this.initialized) {
			...
			Effect.Fade(this.MBwindow, { duration: this.options.slideUpDuration, afterFinish: this._deinit.bind(this) } );
	...
	_removeElements: function () {
        ...
        //THIS IS COMMENTED FOR ENABLEING SCROLL ON IE;
	...
	_setPosition: function () {
		...
		this.MBwindow.style.top = lightboxTop + 'px';
	},
...
Object.extend(Object.extend(Effect.ScaleBy.prototype, Effect.Base.prototype), {
  ...
  setDimensions: function(height, width) {
	...
	//d.top = document.viewport.getHeight()/2 + 'px';
