...
//				Zoom toggle
        ...
        $(iDocument).on('mousedown', '.pbuilder_drag_handle, .pbuilder_drag', function (e) {
            ...
            if ($(this).hasClass('pbuilder_drag_handle')) {
                 ...
                 * Date: 2-3-2015
                 * issue: vertical scrolling was not working on drag and drop
                 * Edit Start
                 */
                $(iDocument).on('mousemove', 'body, .pbuilder_drag', function (e) {

                    var percent = e.clientY / $(window).height();
                    //$('body').scrollTop($(document).height() * percent);
                    $('#pbuilder_body_frame').contents().find("html, body").scrollTop($('#pbuilder_body_frame').contents().height() * percent);
                });
                /*
                 * Code Added By Asim Ashraf - DevBatch
                 * Date: 2-3-2015
