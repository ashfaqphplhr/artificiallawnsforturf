...
if($templates->value != '')
    ...
    $templates = array();
if(count($templates) <= 0) $templates = array("");
            ...
            array(
				...
				'options' => array(
					array(
						...
						'type' => 'input',
						'label' => 'App ID:',
                        'desc' => 'To setup Moderation, enter your&nbsp;<a target="_blank" href="http://developers.facebook.com/docs/appsonfacebook/tutorial/">Facebook Application ID</a>&nbsp;above.',
						'std' => '',
