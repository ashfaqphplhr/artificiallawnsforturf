            ...
            'group_heading' => array(
                ...
                'options' => array(
                    'fb_app_id' => array(
                        'type' => 'input',
                        'label' => 'App ID:',
                        'desc' => 'To setup Comments, enter your&nbsp;<a target="_blank" href="http://developers.facebook.com/docs/appsonfacebook/tutorial/">Facebook Application ID</a>&nbsp;above.',
                        'std' => (isset($opts['fb_app_id']) ? $opts['fb_app_id'] : ''),
