...
// ------------------------------------------------
$edata=mysql_query("select aff_approve_testi_sub, aff_approve_testi_body from idevaff_email_$email_table_extension");
...
// ----------------------------------------------------------
$get_attachment = mysql_query("select template_id, filename from idevaff_email_attachments where template_id = '2' and enabled = '1'");
