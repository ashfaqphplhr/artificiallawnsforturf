...
// ------------------------------------------------
$adata=mysql_query("select id, username, password, f_name, l_name, email from idevaff_affiliates where id = '$linkid'");
...
$e=$indv_data['email'];
// ------------------------------------------------
$edata=mysql_query("select admin_notify_logo_sub, admin_notify_logo_body from idevaff_email_english");
