...
// ------------------------------------------------
$edata=mysql_query("select declined_subject, declined_body from idevaff_email_$email_table_extension");
...
// ----------------------------------------------------------
$get_attachment = mysql_query("select template_id, filename from idevaff_email_attachments where template_id = '3' and enabled = '1'");
