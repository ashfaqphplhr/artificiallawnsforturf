...
$edata=mysql_query("select new_app_subject, new_app_body from idevaff_email_$email_table_extension");
...
// ----------------------------------------------------------
$get_attachment = mysql_query("select template_id, filename from idevaff_email_attachments where template_id = '4' and enabled = '1'");
