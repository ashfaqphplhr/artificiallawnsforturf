...
$adata=mysql_query("select id, username, password, f_name, l_name, email, email_override from idevaff_affiliates where username = '$eusername'");
...
// ------------------------------------------------
$edata=mysql_query("select rew_subject, rew_body from idevaff_email_$email_table_extension");
...
// ----------------------------------------------------------
$get_attachment = mysql_query("select template_id, filename from idevaff_email_attachments where template_id = '6' and enabled = '1'");
