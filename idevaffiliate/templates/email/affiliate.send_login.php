...
$con = preg_replace("/_password_/", "$new_password", $con);
...
// ----------------------------------------------------------
$get_attachment = mysql_query("select template_id, filename from idevaff_email_attachments where template_id = '7' and enabled = '1'");
