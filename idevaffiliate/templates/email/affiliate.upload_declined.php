...
// ------------------------------------------------
$edata=mysql_query("select aff_img_dec_sub, aff_img_dec_body from idevaff_email_$email_table_extension");
...
// ----------------------------------------------------------
$get_attachment = mysql_query("select template_id, filename from idevaff_email_attachments where template_id = '9' and enabled = '1'");
