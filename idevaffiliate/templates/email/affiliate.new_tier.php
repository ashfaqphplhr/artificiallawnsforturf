...
// ------------------------------------------------
$adata=mysql_query("select id, username, password, f_name, l_name, email, email_override from idevaff_affiliates where id = '$insert_tier'");
...
// ------------------------------------------------
$edata=mysql_query("select aff_new_tier_sub, aff_new_tier_body from idevaff_email_$email_table_extension");
