...
$adata=mysql_query("select id, username, password, f_name, l_name, email from idevaff_affiliates where id = '$af'");
...
$edata=mysql_query("select admin_rec_subject, admin_rec_body from idevaff_email_english");
