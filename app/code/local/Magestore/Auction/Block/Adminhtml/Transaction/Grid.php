...
class Magestore_Auction_Block_Adminhtml_Transaction_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  ...
  protected function _prepareCollection()
  {
	  ...
	  $collection->getSelect()
			...
			->join($orderTable, "$orderTable.entity_id = main_table.order_id", array("order_number"=>"increment_id", "created_date"=>"created_at", "total_amount"=>"grand_total"))
			;
  ...
  protected function _prepareColumns()
  {
	...
	$productAuctionTable = Mage::getModel('core/resource')->getTableName('auction_product');
	  ...
	  $this->addColumn('grand_total', array(
          'header'    => Mage::helper('auction')->__('Total Amount'),
          'align'     =>'right',
		  'sortable'  => true,
		  'renderer'  => 'auction/adminhtml_transaction_renderer_amount',
          'index'     => $orderTable.'.grand_total',
		  'type'	  => 'price',
      ...
      $this->addColumn('created_at', array(
          ...
          'align'     =>'left',
          'index'     => $orderTable.'.created_at',
		  'type'      => 'date',
		  'sortable'  => true,
		  'renderer'  => 'auction/adminhtml_transaction_renderer_createat',
      ));	  
