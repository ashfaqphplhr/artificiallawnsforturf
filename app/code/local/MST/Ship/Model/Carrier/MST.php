<?php
class MST_Ship_Model_Carrier_MST extends Mage_Shipping_Model_Carrier_Abstract
implements Mage_Shipping_Model_Carrier_Interface {
	...
	public function collectRates(Mage_Shipping_Model_Rate_Request $request)
	{
		...
		$price = Mage::helper('ship')->getShippingPrice($packageValue);
		/*
	...
	{
		return array('mst'=>$this->getConfigData('name'));
	}
}