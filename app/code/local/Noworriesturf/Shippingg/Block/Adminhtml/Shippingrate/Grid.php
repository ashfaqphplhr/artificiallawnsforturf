 ...
 */
/**
 * Shipping Rate (Melbourne) admin grid block
 *
 * @category	Noworriesturf
 * @package		Noworriesturf_Shippingg
 * @author Ultimate Module Creator
 */
class Noworriesturf_Shippingg_Block_Adminhtml_Shippingrate_Grid extends Mage_Adminhtml_Block_Widget_Grid{
	/**
	 * constructor
	 * @access public
	 * @return void
	 ...
	 * prepare collection
	 * @access protected
	 * @return Noworriesturf_Shippingg_Block_Adminhtml_Shippingrate_Grid
	 * @author Ultimate Module Creator
	 */
	protected function _prepareCollection(){
		$collection = Mage::getModel('shippingg/shippingrate')->getCollection();
	 ...
	 * get the row url
	 * @access public
	 * @param Noworriesturf_Shippingg_Model_Shippingrate
	 * @return string
	 * @author Ultimate Module Creator
	 */
	 ...
	 * filter store column
	 * @access protected
	 * @param Noworriesturf_Shippingg_Model_Resource_Shippingrate_Collection $collection
