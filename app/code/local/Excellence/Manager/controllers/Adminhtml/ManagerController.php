...
class Excellence_Manager_Adminhtml_ManagerController extends Mage_Adminhtml_Controller_action
{
	...
	protected function _initAction() {
		...
		->_addBreadcrumb(Mage::helper('adminhtml')->__('Request Sample'), Mage::helper('adminhtml')->__('Request Sample'));
	...
	public function editAction() {
		...
		if ($model->getId() || $id == 0) {
			...
			$this->_addBreadcrumb(Mage::helper('adminhtml')->__('Request Sample'), Mage::helper('adminhtml')->__('Request Sample'));
