...
class FME_Prodfaqs_Block_Adminhtml_Prodfaqs_Edit_Tab_Products extends Mage_Adminhtml_Block_Widget_Grid
{
	...
	protected function _getProduct(){
		...
		return Mage::registry('current_products_faqs');
	}
	...
	protected function _addColumnFilterToCollection($column){
		...
		if ($column->getId() == 'in_products') {
			    ...
			    $productIds = $this->_getSelectedFaqProducts();
	...
	protected function _prepareColumns(){
		...
		if (!$this->isReadonly()) {
			  ...
			  'type'              => 'checkbox',
			  'name'              => 'in_products',
			  'values'            => $this->_getSelectedFaqProducts(),
			  'align'             => 'center',
			  'index'             => 'entity_id'
		      ));
		  }
	...
	public function _getSelectedFaqProducts(){
	
		$products = null;
		
		$products = array_keys($this->getProductFaqs());
