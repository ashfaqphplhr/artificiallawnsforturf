...
class FME_Prodfaqs_Block_Adminhtml_Topic_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        if( Mage::registry('topic_data') && Mage::registry('topic_data')->getId() ) {
            return Mage::helper('prodfaqs')->__("Edit Topic '%s'", $this->htmlEscape(Mage::registry('topic_data')->getTitle()));
	    
        } else {
            return Mage::helper('prodfaqs')->__('Add Topic');
        }
    }
}